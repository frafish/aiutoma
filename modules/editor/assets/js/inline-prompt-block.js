(function(wp) {
    ...
    registerBlockType('aiutoma/prompt', {
        title: 'Aiutoma Generate',
        description: 'Generate a full layout or blocks inline using Aiutoma',
        icon: 'superhero',
        category: 'design',
        attributes: {
        ...
        edit: function(props) {
            ...
            const handleGenerate = () => {
                ...
                const $sendBtn = jQuery('#aiutoma-agent-send');
                ...
                if ($chatbot.length && $prompt.length && $sendBtn.length) {
                    ...
                    alert('Aiutoma Agent is not active or could not be found. Please ensure the agent is enabled in the settings.');
                }
            };
            ...
            return createElement(
                'div',
                {
                    className: 'wp-block-aiutoma-prompt',
                    style: {
                        padding: '16px',
                        background: '#f8fafc',
                ...
                [
                    createElement('div', { style: { display: 'flex', alignItems: 'center', marginBottom: '12px' } }, [
                        ...
                        createElement('strong', { style: { color: '#0f172a', fontSize: '16px' } }, 'Build with Aiutoma')
                    ]),
