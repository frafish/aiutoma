...
trait Context {
    ...
    private function get_environment_details() {
        ...
        $active_blocks = apply_filters('aiutoma_active_blocks', $active_blocks);
        
        $latest_errors = '';
        $upload_basedir = wp_upload_dir()['basedir'] ?? '';
        $debug_log_path = ($upload_basedir ? dirname($upload_basedir) : (defined('WP_CONTENT_DIR') ? constant('WP_CONTENT_DIR') : '')) . '/debug.log';
        ...
        return "ENVIRONMENT DETAILS:\n"
            ...
            . "- Root Directory: " . (function_exists('get_home_path') ? get_home_path() : ABSPATH) . "\n"
