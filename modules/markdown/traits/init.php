...
trait Init {
    ...
    public function add_markdown_rewrite_rules() {
        add_rewrite_rule('^index\.md$', 'index.php?pagename=index&aiutoma_md=1', 'top');
        add_rewrite_rule('(.+?)\.md$', 'index.php?pagename=$matches[1]&aiutoma_md=1', 'top');
    }
