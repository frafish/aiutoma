...
trait Wpml
{
    public function register_wpml_abilities()
    {
        if (defined('ICL_SITEPRESS_VERSION')) {
            \Aiutoma\Modules\Ai\Abilities::register('wpml/manage', [
                'category' => 'wpml',
                'label' => __('Manage Translations', 'aiutoma'),
                'description' => __('Translate posts, media, terms, and strings using WPML.', 'aiutoma'),
